...
const SingleVaccinePage = () => {
  const children = [
    {
      id: 1,
      imageName: require('../../images/face.png'),
      childName: 'Vaccines in the market today',
      totalVaccinationAmount: 5,
      dateVaccinated: Date.now(),
      description: 'He is a ranbuncious child and he is dope. He spends his time having fun and watching Barney and friends',
      childAge: 8,
      location: 'Lagos',
    },
  ];
...
export default SingleVaccinePage;
