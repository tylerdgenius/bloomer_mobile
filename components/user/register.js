      ...
      <View style={{ flex: 5 }}>
        <View style={{ flex: 1, marginHorizontal: 40 }}>
          ...
          <View style={{ flex: 0.4 }}>
            ...
            <TextInput
              placeholder="e.g 5th February 2019"
              style={styles.textInsert}
            ></TextInput>
          </View>

          {/* <View style={{ flex: 0.1, alignItems: 'center', marginTop: 10 }}>
          {show && <DateTimePicker value={date} onChange={() => {
        setDate(value)
        setShow(false)
      }} mode="date" display="spinner" testID="dateTimePicker"/>}
            <TouchableOpacity onPress={() => showstuff()}>
